...
public class Lesson02Ex1Fix {
    public static void main(String[] args) throws IOException {
        Lesson02Ex1.Coca coca = new Lesson02Ex1.Coca("Кока-Кола Vanilla", 2.4, "a1");
        Lesson02Ex1.Mars mars = new Lesson02Ex1.Mars("Mars с Орехами", 2.1, "a2");
        Lesson02Ex1.Milk milk = new Lesson02Ex1.Milk("Домик в деревне", 1.2, "b1");
        Lesson02Ex1.Snic snic = new Lesson02Ex1.Snic("Snickers Super", 2.7, "b2");
